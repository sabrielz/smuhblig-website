...
export default function ErrorGeneric({ status }: { status: number }) {
    return (
        <PublicLayout>
            <Head title={`${status} Terjadi Kesalahan — SMK Muhammadiyah Bligo`} />
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="relative z-10 flex flex-col items-center mt-10 md:mt-20">
                            ...
                            <p className="text-lg md:text-xl text-white/70 max-w-lg mb-12">
                                Mohon maaf, ada sesuatu yang tidak beres. Silakan coba muat ulang halaman atau kembali ke beranda.
                            </p>
